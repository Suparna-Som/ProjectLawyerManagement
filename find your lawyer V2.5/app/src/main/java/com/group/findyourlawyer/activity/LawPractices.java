...
import static com.group.findyourlawyer.R.id.Enrollment;
import static com.group.findyourlawyer.R.id.textView;
...
public class LawPractices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.adapter_listview, textView, strings);
    }
        ...
        multiSelectDialog = new MultiSelectDialog()
                ...
                .onSubmit(new MultiSelectDialog.SubmitCallbackListener() {
                    ...
                    public void onSelected(ArrayList<Integer> selectedIds, ArrayList<String> selectedNames, String dataString) {
                        ...
                        adapter = new ArrayAdapter<>(LawPractices.this, R.layout.adapter_listview, textView, selectedNames);
