...
public class LawyerReviewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lawyer_reviews);

        Intent intent = getIntent();
        String key = intent.getStringExtra("key");

        editText = findViewById(R.id.editText1);
        Post = FirebaseDatabase.getInstance().getReference().child("Lawyer").child(key).child("Reviews");
